        ...
        <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
            ...
            <form>
                <div className="form-group row">
                    ...
                    <div className="col-8">
                        <input className="form-control" id="nombre" name="nombre" type="text" />
                    </div>                    
                </div>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-8">
                        <input className="form-control" id="documento" name="documento" type="text" />
                    </div>						
                </div>
                ...
                <div className="form-group row">
                    ...
                    <div className="col-8">
                        <input className="form-control" id="placa" name="placa" type="text" />
                    </div>                    
                </div>
